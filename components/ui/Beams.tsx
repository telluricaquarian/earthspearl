...
/* Adapted from React Bits — https://reactbits.dev/backgrounds/beams
   Changes vs. original:
   - TypeScript
   - PerspectiveCamera inlined via Canvas `camera` prop (removes @react-three/drei dep)
   - Canvas background set to #0f0a00 (site base) instead of #000000
*/
...
export default function Beams({
  ...
  return (
    ...
    >
      ...
      <color attach="background" args={['#0f0a00']} />
    </Canvas>
  )
}
